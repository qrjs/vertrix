...
foreach file {
    vproc_top.sv vproc_core.sv vproc_decoder.sv vproc_lsu.sv vproc_alu.sv
...
if {[string first "ibex" $core_dir] != -1} {
    ...
    foreach file {ibex_pkg.sv ibex_top.sv ibex_core.sv ibex_alu.sv ibex_branch_predict.sv
        ...
        lappend src_list "$core_rtl_dir/$file"
    }
    lappend src_list "$vproc_dir/syn/rtl/prim_clock_gating.v"
    lappend src_list "$vendor_dir/dv/sv/dv_utils/"
    lappend src_list "$vendor_dir/ip/prim/rtl/"
} else {
