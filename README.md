...
directly couples to the main core using explicit issue/commit/result signals.
Currently, a modified version of the [Ibex core](https://github.com/lowRISC/ibex)
serves as the main core. Support for further RISC-V CPUs is under development.
