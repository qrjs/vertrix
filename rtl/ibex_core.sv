...
`endif
  ...
  // SpecBranch disabled (no PMP support)
  localparam bit          SpecBranch        = 1'b0;
  ...
  // No PMP/multi-privilege support - always M-mode
...
`endif
  ...
  ibex_cs_registers #(
      ...
      .instr_ret_compressed_i  ( 1'b0                         ),  // No compressed instructions
