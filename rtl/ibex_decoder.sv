...
module ibex_decoder #(
  ...
  // No RV32B support - rs3 not used
  logic unused_clk;
  logic unused_rst_n;
  assign unused_clk = clk_i;
  assign unused_rst_n = rst_ni;
  assign use_rs3_q = 1'b0;
  ...
  // Register check //
  ////////////////////
  // RV32E not supported - all 32 registers available
    ...
    unique case (opcode)
      ...
      OPCODE_OP_IMM: begin // Register-Immediate ALU Operations
        ...
        unique case (instr[14:12])
          ...
          3'b001: begin
            // Only SLLI is supported (standard RV32I)
            illegal_insn = (instr[31:27] == 5'b0_0000 && instr[26:25] == 2'b00) ? 1'b0 : 1'b1;
          end

          3'b101: begin
            // Only SRLI and SRAI are supported (standard RV32I)
    ...
    unique case (opcode_alu)
      ...
      OPCODE_OP_IMM: begin // Register-Immediate ALU Operations
        ...
        unique case (instr_alu[14:12])
          ...
          3'b001: begin
            // Only SLLI supported (RV32I)
            alu_operator_o = ALU_SLL;
          end

          3'b101: begin
            // SRLI and SRAI only (RV32I)
      ...
      OPCODE_OP: begin  // Register-Register ALU operation
        ...
        unique case ({instr_alu[31:25], instr_alu[14:12]})
          ...
          {7'b000_0000, 3'b010}: alu_operator_o = ALU_SLT;   // slt
          {7'b000_0000, 3'b011}: alu_operator_o = ALU_SLTU;  // sltu
          {7'b000_0000, 3'b100}: alu_operator_o = ALU_XOR;   // xor
          {7'b000_0000, 3'b110}: alu_operator_o = ALU_OR;    // or
          {7'b000_0000, 3'b111}: alu_operator_o = ALU_AND;   // and
          {7'b000_0000, 3'b001}: alu_operator_o = ALU_SLL;   // sll
          {7'b000_0000, 3'b101}: alu_operator_o = ALU_SRL;   // srl
          {7'b010_0000, 3'b101}: alu_operator_o = ALU_SRA;   // sra
