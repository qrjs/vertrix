...
module vproc_pending_wr #(
    ...
    // Use stable Vicuna pending-write behavior by default.
    // The experimental VL-dependent version can be enabled with
    // `VPROC_EXPERIMENTAL_PENDING_WR`.
    `ifndef VPROC_EXPERIMENTAL_PENDING_WR
        always_comb begin
