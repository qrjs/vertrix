...
It directly couples to the main core using explicit issue/commit/result signals.
Currently, a modified version of the `Ibex core <https://github.com/lowRISC/ibex>`__
